...
from .cuhkpedes_rgbt import CUHKPEDES
from .icfgpedes import ICFGPEDES
from .rstpreid_rgbt import RSTPReid
from .rgbtpedes import RGBTPEDES

__factory = {'CUHK-PEDES': CUHKPEDES, 'ICFG-PEDES': ICFGPEDES, 'RSTPReid': RSTPReid, 'RGBT-PEDES': RGBTPEDES}
...
def collate(batch):
    ...
    for k, v in dict_batch.items():
        ...
        elif isinstance(v[0], str) or v[0] is None:
            # For strings or None, keep as a list (unchanged)
...
def build_dataloader(args, tranforms=None):
    ...
    if args.training:
        ...
        val_img_set = ImageDataset(ds['image_pids'], ds['rgb_img_paths'], ds['t_img_paths'],
                                   val_transforms)
        ...
        ds = dataset.test
        test_img_set = ImageDataset(ds['image_pids'], ds['rgb_img_paths'], ds['t_img_paths'],
                                    test_transforms)
